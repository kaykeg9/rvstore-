...
import { ShoppingBag, Menu, X, Phone, Instagram, MapPin, Star, Settings, Plus, Edit, Trash2, Eye, EyeOff, ArrowRight, Zap, Shield, Truck, Award, TrendingUp, Users, Heart } from 'lucide-react'
...
Obrigado pela preferência! 🙏`
  ...
  const ProductCard = ({ product, isAdminView = false, featured = false }) => {
    ...
    return (
      <Card className={`group cursor-pointer hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 bg-white/80 backdrop-blur-sm border-0 overflow-hidden ${
        ...
        <CardContent className="p-0">
          <div className="aspect-square relative overflow-hidden">
            ...
            <div className="absolute top-3 left-3 flex flex-col gap-2">
              <div className="bg-black/80 backdrop-blur-sm text-white px-3 py-1 text-xs rounded-full font-medium">
                {product.category}
              </div>
              {product.isPromotion && (
                <div className="bg-gradient-to-r from-red-500 to-pink-500 text-white px-3 py-1 text-xs rounded-full font-bold animate-pulse">
                  OFERTA
                </div>
              )}
              {product.isNew && (
                <div className="bg-gradient-to-r from-green-500 to-emerald-500 text-white px-3 py-1 text-xs rounded-full font-bold">
                  NOVO
                </div>
              )}
              {product.isBestSeller && (
                <div className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white px-3 py-1 text-xs rounded-full font-bold">
                  ⭐ BEST
                </div>
              )}
            </div>
          ...
          <div className="p-6">
            <h4 className="font-bold text-xl mb-2 text-gray-900 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-purple-600 group-hover:to-pink-600 transition-all duration-300">
              {product.name}
            </h4>
            ...
            {isAdminView && (
              <div className="mb-4 flex gap-2 flex-wrap">
                ...
                <Badge variant="outline" className="text-xs">Estoque: {product.stock}</Badge>
            ...
            {!isAdminView && (
              <Button
                ...
                className="w-full bg-gradient-to-r from-gray-900 to-black hover:from-black hover:to-gray-800 text-white py-3 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
              >
    ...
    return (
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <Label htmlFor="cart-name" className="text-gray-700 font-medium">Nome Completo</Label>
            <Input
              id="cart-name"
          ...
          <div>
            <Label htmlFor="cart-whatsapp" className="text-gray-700 font-medium">WhatsApp</Label>
            <Input
              id="cart-whatsapp"
        ...
        <div>
          <Label htmlFor="cart-address" className="text-gray-700 font-medium">Endereço Completo</Label>
          <Textarea
            id="cart-address"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center">
              <h1 className="text-3xl font-bold bg-gradient-to-r from-gray-900 via-black to-gray-800 bg-clip-text text-transparent">
                RV STORE
              </h1>
              <div className="ml-3 w-2 h-2 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full animate-pulse"></div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              <div className="relative">
                <ShoppingBag 
                  className="h-6 w-6 text-gray-700 hover:text-black transition-colors cursor-pointer" 
                ...
                {cart.length > 0 && (
                  <div className="absolute -top-2 -right-2 w-5 h-5 bg-gradient-to-r from-red-500 to-pink-500 rounded-full flex items-center justify-center animate-pulse">
                    <span className="text-xs text-white font-bold">{cart.reduce((sum, item) => sum + item.quantity, 0)}</span>
                  </div>
                )}
              </div>
              ...
              {!isAdmin ? (
                ...
                <Button
                  ...
                  className="hidden md:flex text-sm hover:bg-gray-100 transition-colors"
                >
                  Sair Admin
                </Button>
              )}
      ...
      <Dialog open={showAdminLogin} onOpenChange={setShowAdminLogin}>
        <DialogContent className="sm:max-w-md bg-white/95 backdrop-blur-sm border-0 shadow-2xl">
          ...
          <form onSubmit={handleAdminLogin} className="space-y-4">
            <div>
              <Label htmlFor="admin-password" className="text-gray-700 font-medium">Senha de Administrador</Label>
              <Input
                id="admin-password"
                type="password"
                value={adminPassword}
      ...
      <Dialog open={showProductForm} onOpenChange={setShowProductForm}>
        <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto bg-white/95 backdrop-blur-sm border-0 shadow-2xl">
          ...
          <form onSubmit={handleSaveProduct} className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <Label htmlFor="product-name" className="text-gray-700 font-medium">Nome do Produto</Label>
                <Input
                  id="product-name"
              ...
              <div>
                <Label htmlFor="product-category" className="text-gray-700 font-medium">Categoria</Label>
                <Select 
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div>
                <Label htmlFor="product-price" className="text-gray-700 font-medium">Preço Atual (R$)</Label>
                <Input
                  id="product-price"
                  type="number"
                  step="0.01"
              ...
              <div>
                <Label htmlFor="product-original-price" className="text-gray-700 font-medium">Preço Original (R$)</Label>
                <Input
              ...
              <div>
                <Label htmlFor="product-stock" className="text-gray-700 font-medium">Estoque</Label>
                <Input
                  id="product-stock"
                  type="number"
              ...
              <div>
                <Label htmlFor="product-rating" className="text-gray-700 font-medium">Avaliação</Label>
                <Input
                  id="product-rating"
                  type="number"
                  step="0.1"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <Label htmlFor="product-image" className="text-gray-700 font-medium">URL da Imagem</Label>
                <Input
                  id="product-image"
              ...
              <div>
                <Label htmlFor="product-reviews" className="text-gray-700 font-medium">Número de Avaliações</Label>
                <Input
                  id="product-reviews"
                  type="number"
            ...
            <div>
              <Label htmlFor="product-description" className="text-gray-700 font-medium">Descrição</Label>
              <Textarea
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="product-active" className="text-gray-700 font-medium">Ativo</Label>
              </div>
              <div className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  ...
                  className="rounded border-gray-300 text-purple-600 focus:ring-purple-500"
                />
                <Label htmlFor="product-promotion" className="text-gray-700 font-medium">Promoção</Label>
              </div>
              <div className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  ...
                  className="rounded border-gray-300 text-purple-600 focus:ring-purple-500"
                />
                <Label htmlFor="product-new" className="text-gray-700 font-medium">Novo</Label>
              </div>
              <div className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  ...
                  className="rounded border-gray-300 text-purple-600 focus:ring-purple-500"
                />
                <Label htmlFor="product-bestseller" className="text-gray-700 font-medium">Best Seller</Label>
              </div>
            </div>
            ...
            <div className="flex gap-2">
              <Button 
                type="submit" 
                className="flex-1 bg-gradient-to-r from-green-600 to-green-500 hover:from-green-700 hover:to-green-600 py-3 rounded-full font-semibold transition-all duration-300"
              >
                      ...
                      <div className="flex justify-between items-center mb-2 text-green-600">
                        ...
                        <span className="font-bold">
                          R$ {cart.reduce((sum, item) => 
                            sum + (item.isPromotion ? (item.originalPrice - item.price) * item.quantity : 0), 0
                          ).toFixed(2)}
                        </span>
                      </div>
                    )}
          ...
          <>
            <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
              ...
              <div className="absolute inset-0">
                <Image
                  src="/stylish-man-rv-fashion.png"
                  alt="Homem elegante usando roupas RV STORE"
                  fill
              ...
              <div className="relative z-10 text-center max-w-6xl mx-auto px-4">
                <div className="mb-8 animate-fade-in-up">
                  ...
                  <p className="text-2xl md:text-3xl mb-12 bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent font-bold">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in-up animation-delay-300">
                  <Button
                    onClick={() => setCurrentSection("produtos")}
                    size="lg"
                    className="bg-gradient-to-r from-white to-gray-100 text-black hover:from-gray-100 hover:to-white text-lg px-12 py-4 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 shadow-2xl"
                  >
                    Explorar Produtos
                  ...
                  <Button
                    ...
                    variant="outline"
                    size="lg"
                    className="border-2 border-white/30 text-white hover:bg-white/10 backdrop-blur-sm text-lg px-12 py-4 rounded-full font-semibold transition-all duration-300 transform hover:scale-105"
                  >
                    Nossa História
                  </Button>
                </div>
            ...
            <section className="py-20 bg-gradient-to-r from-gray-900 to-black text-white">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
                  <div className="group">
                    <div className="text-4xl font-bold mb-2 bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent group-hover:scale-110 transition-transform duration-300">
                      1000+
                    </div>
                  ...
                  <div className="group">
                    ...
                    <p className="text-gray-300">Entrega Rápida</p>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section className="py-20 bg-gradient-to-br from-gray-50 to-white">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mt-12">
                  <Button
                    onClick={() => setCurrentSection("produtos")}
                    className="bg-gradient-to-r from-gray-900 to-black hover:from-black hover:to-gray-800 text-white px-8 py-4 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg"
                  >
            ...
            <section className="py-20 bg-gradient-to-r from-gray-900 to-black text-white">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                  <h3 className="text-4xl font-bold mb-4">Por que escolher a RV STORE?</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  <div className="text-center group">
                    ...
                    <p className="text-gray-300 leading-relaxed">
                      Produtos selecionados com os melhores materiais e acabamentos premium
                    </p>
                  </div>
                  ...
                  <div className="text-center group">
                    ...
                    <h4 className="text-2xl font-bold mb-4">Entrega Rápida</h4>
                    <p className="text-gray-300 leading-relaxed">
                  ...
                  <div className="text-center group">
                    ...
                    <h4 className="text-2xl font-bold mb-4">Atendimento VIP</h4>
                    <p className="text-gray-300 leading-relaxed">
                      Suporte personalizado via WhatsApp para melhor experiência
                    </p>
                  </div>
                </div>
              </div>
          ...
          <section className="py-20 bg-gradient-to-br from-gray-50 to-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="flex flex-wrap justify-center gap-4 mb-12">
                <Button
                  variant="outline"
                  className="rounded-full px-6 py-2 border-2 border-gray-300 hover:border-purple-500 hover:text-purple-600 transition-all duration-300"
                >
                  Todos
                </Button>
                {categories.map(category => (
        ...
        {currentSection === "sobre" && (
          <section className="py-20">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="bg-gradient-to-br from-white to-gray-50 p-12 rounded-3xl shadow-2xl border border-gray-100">
                <p className="text-xl leading-relaxed text-gray-700 mb-8 text-center max-w-4xl mx-auto">
                  A RV STORE nasceu da paixão por moda e estilo. Trabalhamos com peças selecionadas para homens que querem se destacar com atitude e personalidade. Entregamos para todo o Brasil com segurança e agilidade.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mt-16">
                  <div className="text-center group">
                    ...
                    <h3 className="font-bold text-2xl mb-4 text-gray-900">Qualidade Premium</h3>
                    <p className="text-gray-600 leading-relaxed">
                      Peças selecionadas com os melhores materiais e acabamentos, garantindo durabilidade e conforto.
                    </p>
                  </div>
                  ...
                  <div className="text-center group">
                    ...
                    <h3 className="font-bold text-2xl mb-4 text-gray-900">Estilo Único</h3>
                    <p className="text-gray-600 leading-relaxed">
                      Designs exclusivos e tendências atuais para homens que querem se destacar com personalidade.
                    </p>
                  </div>
                  ...
                  <div className="text-center group">
                    ...
                    <h3 className="font-bold text-2xl mb-4 text-gray-900">Atendimento Personalizado</h3>
                    <p className="text-gray-600 leading-relaxed">
                      Suporte completo via WhatsApp com atendimento humanizado para melhor experiência de compra.
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center space-x-4 group">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-lg">(81) 99663-0750</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center space-x-4 group">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-lg">@rvstore.1</p>
                      </div>
                    </div>
                    
                    <div className="flex items-center space-x-4 group">
                      <div className="w-14 h-14 bg-gradient-to-r from-red-500 to-red-600 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg">
                        <MapPin className="h-7 w-7 text-white" />
                      </div>
                      <div>
                        <p className="font-bold text-lg text-gray-900">Endereço</p>
                        <p className="text-gray-600">Av. Gov. Agamenon Magalhães N° 644</p>
                        <p className="text-gray-600">CAVALEIRO - Olinda, PE</p>
                      </div>
                    </div>
                  </div>
                </div>
                
                <div className="bg-gradient-to-br from-gray-900 to-black p-8 rounded-3xl shadow-2xl text-white">
                  ...
                  <Button
                    onClick={() => window.open('https://wa.me/5581996630750?text=Olá! Gostaria de mais informações sobre os produtos da RV STORE.', '_blank')}
                    className="w-full bg-gradient-to-r from-green-600 to-green-500 hover:from-green-700 hover:to-green-600 py-4 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg text-lg"
                  >
                    <Phone className="h-5 w-5 mr-2" />
                    Falar no WhatsApp
                  </Button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              ...
              <div className="flex space-x-4">
                <div 
                  className="w-10 h-10 bg-gradient-to-r from-green-500 to-green-600 rounded-full flex items-center justify-center hover:scale-110 transition-transform duration-300 cursor-pointer"
                  onClick={() => window.open('https://wa.me/5581996630750', '_blank')}
                >
                  <Phone className="h-5 w-5 text-white" />
                </div>
                <div 
                  className="w-10 h-10 bg-gradient-to-r from-pink-500 to-pink-600 rounded-full flex items-center justify-center hover:scale-110 transition-transform duration-300 cursor-pointer"
            ...
            <div>
              ...
              <div className="space-y-3 text-gray-300">
                ...
                <p className="flex items-start">
                  ...
                  <span>
                    Av. Gov. Agamenon Magalhães N° 644<br />
                    CAVALEIRO - Olinda, PE
                  </span>
                </p>
              </div>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex items-center mt-4 md:mt-0">
                <div className="w-2 h-2 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full animate-pulse mr-2"></div>
